...
const Claim = sequelize.define('Claim', {
  ...
  // Performance: Indexes for frequently queried/sorted fields
  indexes: [
    { fields: ['patientId'] },
    { fields: ['hospitalId'] },
    { fields: ['status'] },
    { fields: ['riskScore', 'createdAt'] }
  ]
});
...
const Notification = sequelize.define('Notification', {
  ...
  // Performance: Index for fetching user notifications in reverse chronological order
  indexes: [
